...
if (empty($triplea_notifications_email)) $triplea_notifications_email = '';

$triplea_server_public_enc_key_btc = $this->get_option('triplea_server_public_enc_key_btc');
if (empty($triplea_server_public_enc_key_btc)) $triplea_server_public_enc_key_btc = '';
$triplea_server_public_enc_key_conversion = $this->get_option('triplea_server_public_enc_key_conversion');
if (empty($triplea_server_public_enc_key_conversion)) $triplea_server_public_enc_key_conversion = '';
...
?>
   ...
   <div class="triplea_step" id="step-enabled" style="display:<?php if($btc2cash_is_active || $btc2btc_is_active) { echo 'block'; } else { echo 'none'; } ?>">
      <hr>
      
      <br>
      <h3>Bitcoin payments are enabled.</h3>
      <p id="btc2btc-message" style="display:<?php if($btc2btc_is_active) { echo 'block'; } else { echo 'none'; } ?>">
         You have chosen to receive bitcoin payments <br>
         straight <strong>into your own bitcoin wallet</strong>.
      </p>
      <p id="btc2cash-message" style="display:<?php if($btc2cash_is_active) { echo 'block'; } else { echo 'none'; } ?>">
         You have chosen to receive bitcoin payments <br>
      ...
      <br>
      <br>
      <div id="btc2btc-action-buttons" style="display:<?php if($btc2btc_is_active) { echo 'block'; } else { echo 'none'; } ?>">
      ...
      <div id="btc2cash-action-buttons" style="display:<?php if($btc2cash_is_active) { echo 'block'; } else { echo 'none'; } ?>">
   ...
   <div class="triplea_step" id="step-1" style="display:<?php if(!$btc2cash_is_active && !$btc2btc_is_active) { echo 'block'; } else { echo 'none'; } ?>">
      <hr>
      <br>
      <h3>Get started</h3>
      <p>
      ...
      <input type="radio" name="receive-choice" value="bitcoin" <?php if ($btc2btc_is_active) { echo "checked"; } ?> style="margin:10px;">receive bitcoin<br>
      <input type="radio" name="receive-choice" value="localcurrency" <?php if ($btc2cash_is_active) { echo "checked"; } ?> style="margin:10px;">receive local currency<br>
      <br>
