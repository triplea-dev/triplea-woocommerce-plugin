...
;( function ( $, window, document ) {
  ...
  const TRIPLEA_PAYMENT_GATEWAY_FOR_WOOCOMMERCE_VERSION = '1.4.0';
   ...
   *
   */
  function triplea_loadQrCodeGenerator()
  {
    !function () {
      function a(a)
      {
      ...
      }, triplea_QRCode.prototype.makeCode = function (a) {
      ...
      }, triplea_QRCode.prototype.makeImage = function () {
        "function" == typeof this._oDrawing.makeImage && (!this._android || this._android >= 3) && this._oDrawing.makeImage()
      }, triplea_QRCode.prototype.clear = function () {
        this._oDrawing.clear()
      }, triplea_QRCode.CorrectLevel = d
    }();
  }
